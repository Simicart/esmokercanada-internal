...
//            ->where('main_table.'. PackRequestInterface::STATUS . '= ?', PackRequestInterface::STATUS_PACKED);
            ->where('main_table.'. PackRequestInterface::STATUS . ' IN (\'' . implode("','", [PackRequestInterface::STATUS_PACKED, PackRequestInterface::STATUS_CANCELED]) . '\')');
