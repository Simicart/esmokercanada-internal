...
class Js extends \Magento\Backend\Block\Template
{
    ...
    public function getConfigDataJson()
    {
        $config = [
            ...
            'recent_picked_listing' => 'os_fulfilsuccess_pickrequest_listing.os_fulfilsuccess_pickrequest_listing.os_fulfilsuccess_recent_picked_container.os_fulfilsuccess_recent_picked_fieldset.os_fulfilsuccess_recent_picked_listing',
