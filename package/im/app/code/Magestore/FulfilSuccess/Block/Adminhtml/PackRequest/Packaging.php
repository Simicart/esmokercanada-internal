...
//            foreach ($this->getShipment()->getAllItems() as $item) {
        ...
        $data = [
            ...
            'recent_packed_listing' => 'os_fulfilsuccess_packrequest_listing.os_fulfilsuccess_packrequest_listing.os_fulfilsuccess_recent_packed_container.os_fulfilsuccess_recent_packed_fieldset.os_fulfilsuccess_recent_packed_listing',
