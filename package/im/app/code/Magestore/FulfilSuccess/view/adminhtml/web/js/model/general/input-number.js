    ...
    return {
        ...
        initHtml: function(el){
            if(el){
                var self = this;
                var elmentId = el.id;
                var decreaseButton = "<button type='button' class='"+self.CLASS.DECREASE_BUTTON+"' data-target='"+elmentId+"'>-</button>";
                var increaseButton = "<button type='button' class='"+self.CLASS.INCREASE_BUTTON+"' data-target='"+elmentId+"'>+</button>";
