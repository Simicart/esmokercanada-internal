...
class Sendmail extends AbstractHelper
{
     ...
     * @return $this
     */
    public function generateTemplate($emailTemplateVariables, $senderInfo, $receiverInfo, $storeId=null)
    {
        if($storeId){
    ...
    public function Send($templateId, $emailTemplateVariables, $receiverInfo, $storeId=null)
    {
        try {
            if($storeId){
                $this->temp_id = $this->getTemplateId($templateId, $storeId);
                $this->inlineTranslation->suspend();
        
                if($storeId == 2){
                    $senderInfo = $this->getConfigValue('customercredit/email/sender2', $storeId);
                }else{
                    $senderInfo = $this->getConfigValue('customercredit/email/sender', $storeId);
                }
