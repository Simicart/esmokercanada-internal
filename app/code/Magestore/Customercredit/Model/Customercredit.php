...
class Customercredit extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function sendNotifytoCustomer($email, $name, $credit_value, $balance, $message, $customer)
    {
        ...
        try {
            ...
            $this->_helperSendmail->Send('customercredit/email/notify', $emailTemplateVariables, $receiverInfo, $customer->getStoreId());
