...
define(
    ...
    function (
        ...
        return colGrid.extend({
            ...
            defaults: {
                template: 'Magestore_WebposCustomize/checkout/customer/edit-customer'
            },
            ...
            loadData: function (data) {
                ...
                if(data.custom_attributes){
                    for(var i = 0; i < data.custom_attributes.length; i++){
                        if(data.custom_attributes[i].attribute_code == "wk_telephone"){
                            self.wk_telephone(data.custom_attributes[i].value);
                            break;
                        }
                        else{
                            self.wk_telephone('');
            ...
            saveCustomerForm: function () {
                ...
                if (this.validateEditCustomerForm()) {
                    ...
                    currentData.custom_attributes = [
                        {attribute_code: "wk_telephone", value: this.wk_telephone()}
                    ];
