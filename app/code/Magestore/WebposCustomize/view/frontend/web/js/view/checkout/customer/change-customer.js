                ...
                if (this.searchKey) {
                    this.collection.addFieldToFilter(
                        [
                            ...
                            ['wk_telephone', "%" + this.searchKey + "%", 'like']
                        ]
                    );
                }
            },
                ...
                deferred.done(function (data) {
                    ...
                    items.forEach(function(item){
                        if(item.custom_attributes){
                            for(var i = 0; i < item.custom_attributes.length; i++){
                                if(item.custom_attributes[i].attribute_code == "wk_telephone"){
                                    item.telephone = item.custom_attributes[i].value;
                                    break;
                                }
                            }
                        }
