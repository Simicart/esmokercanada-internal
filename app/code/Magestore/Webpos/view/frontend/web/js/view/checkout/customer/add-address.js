...
define(
    ...
    function ($, ko, ViewManager, Component, CustomerFactory, countryModel, currentCustomer, Translate, Helper) {
        "use strict";
        return Component.extend({
            ...
            saveAddress: function () {
                ...
                if (this.validateAddressForm()) {
                    ...
                    var mode = Helper.isOnlineCheckout()?"online":"offline";
                    customerDeferred = CustomerFactory.get().setMode(mode).setData(currentCustomerData).setPush(true).save();
            ...
            getAddressData: function () {
                ...
                var regionId = self.region_id()!=""?self.region_id():(jQuery('#region_id').val()==""?0:jQuery('#region_id').val());
