...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
         ...
         */
        $table = $installer->getConnection()->newTable($installer->getTable('magenest_ultimatefollowupemail_guest_abandoned_cart'))->addColumn(
            'id',
            \Magento\Framework\DB\Ddl\Table::TYPE_SMALLINT,
            null,
            [
         ...
         */
        $table = $installer->getConnection()->newTable($installer->getTable('magenest_ultimatefollowupemail_history'))->addColumn(
            'id',
            \Magento\Framework\DB\Ddl\Table::TYPE_SMALLINT,
            null,
            [
            ...
            $installer->getFkName('magenest_ultimatefollowupemail_history', 'quote_id', 'quote', 'entity_id'),
            'quote_id',
            $installer->getTable('quote'),
            'entity_id',
            \Magento\Framework\DB\Ddl\Table::ACTION_SET_NULL
        ...
        // notification email
        $table = $installer->getConnection()->newTable($installer->getTable('magenest_ultimatefollowupemail_mail_notification'))->addColumn(
            'notication_id',
            \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
            null,
            [
        ...
        // sms log
        $table = $installer->getConnection()->newTable($installer->getTable('magenest_ultimatefollowupemail_mail_sms'))->addColumn(
            'sms_id',
            \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
            null,
            [
        ...
        $table = $installer->getConnection()->newTable($installer->getTable('magenest_ultimatefollowupemail_sms_log'))->addColumn(
            'id',
            \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
            null,
            [
