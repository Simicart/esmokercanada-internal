...
class Points extends \Magento\Framework\View\Element\Template
{
    ...
    public function getPoints()
    {
        ...
        $productPoints = $this->earnHelper->getRoundingProductPoints(
            $this->getProduct(),
    ...
    public function getPointsFormatted()
    {
        ...
        $productPrice = $this->earnHelper->getProductPrice($this->getProduct(), null);
        $money  = $this->spendHelper->getProductPointsAsMoney($points, $websiteId, $customerGroupId, $productPrice);
        if ($points != $money) {
