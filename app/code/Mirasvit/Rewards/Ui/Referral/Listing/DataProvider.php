...
class DataProvider extends \Magento\Framework\View\Element\UiComponent\DataProvider\DataProvider
{
    ...
    public function getSearchResult()
    {
        ...
        $collection = $this->getPreparedCollection($fieldCustomer, $fieldCustomerValue, $fieldNewCustomer, $fieldNewCustomerValue);
     ...
     */
    protected function getPreparedCollection($fieldCustomer, $fieldCustomerValue, $fieldNewCustomer, $fieldNewCustomerValue)
    {
