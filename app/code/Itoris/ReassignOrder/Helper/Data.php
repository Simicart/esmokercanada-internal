...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getTemplateParams(\Magento\Sales\Model\Order $order, \Magento\Customer\Model\Customer $customer,  \Magento\Store\Model\Store $store,\Magento\Quote\Model\Quote $quote = null)
    {
        ...
        $templateParams['from_name'] = $quote->getBillingAddress()->getName();
    ...
    public function sendEmail(\Magento\Customer\Model\Customer $customer, $templateId, $templateParams = array(), $store)
    {
        ...
        try {
            ...
            //->sendTransactional($templateId, $sender, $customer->getEmail(), $customer->getName(), $templateParams, $store->getId());
