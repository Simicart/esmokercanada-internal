...
define([
    ...
    $.widget('itoris.priceBundle', $.mage.priceBundle, {
        ...
        _create: function createPriceBundle() {
            ...
            if (priceBox.data('magePriceBox') && priceBox.priceBox('option') && priceBox.priceBox('option').priceConfig) {
                ...
                priceBox.priceBox('setDefaultCustom', this.options.optionConfig.prices);
            }
            this._applyQtyFix();
        ...
        _onBundleOptionChanged: function onBundleOptionChanged(event) {
            var changes,
               ...
               productId = $(event.target).closest('.itoris_slider_group').attr('data_product_id'),
                priceBox = $(this.options.priceBoxSelector="[data-role=priceBox][data-product-id="+productId+"]", this.element),
                handler = this.options.optionHandlers[bundleOption.data('role')];
                this.options.optionConfig=bundleConfig[productId];
            ...
            if (changes) {
                ...
                changes.productTypeId='bundle';
                priceBox.trigger('updatePriceBundle', changes);
            }
