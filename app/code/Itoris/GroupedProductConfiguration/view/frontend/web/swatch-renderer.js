    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _init: function () {
            if (this.options.jsonConfig !== '' && this.options.jsonSwatchConfig !== '') {
                ...
                this._RenderControls(productId);
            } else {
         ...
         * @private
         */
        _RenderControls: function (productId) {
            var $widget = this,
            ...
            $.each(this.options.jsonConfig.attributes, function () {
                ...
                $widget.productForm=$('#product_addtocart_form');
        ...
        _RenderFormInput: function (config,productId) {
             var qtyConfigurable = $('#options-'+productId).val();
            if(isNaN(qtyConfigurable-0) || qtyConfigurable-0 == 0) {
                return '<input class="' + this.options.classes.attributeInput + ' super-attribute-select itoris-input-swatch-' + productId + '" ' +
        ...
        _OnClick: function ($this, $widget) {
            var $parent = $this.parents('.' + $widget.options.classes.attributeClass),
                ...
                productId = $parent.parent('.itoris-swatch-grouped').attr('data-product'),
                $input = $widget.productForm.find(
                    '.' + $widget.options.classes.attributeInput + '[name="super_attribute['+productId+'][' + attributeId + ']"]'
                );
            if ($this.hasClass('disabled')) {
                return;
            }
            ...
            $widget._Rebuild();
                ...
                $widget._UpdatePrice(productId);


            $widget._LoadProductMedia(productId,$this);
        ...
        _UpdatePrice: function (productId) {
            var $widget = this,
                ...
                result;
            $productPrice = $(this.options.selectorProductPrice+'[data-product-id='+productId+']');
            $product = $(this.options.selectorProductPrice+'[data-product-id='+productId+']');
         ...
         * @private
         */
        _LoadProductMedia: function (productId,element) {
            var $widget = this,
                $this = $widget.element,
                attributes = {},
                productId = productId,
