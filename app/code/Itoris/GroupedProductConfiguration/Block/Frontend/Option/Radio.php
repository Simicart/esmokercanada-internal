 ...
 */
class Radio extends \Itoris\GroupedProductConfiguration\Block\Frontend\Option
{
    /**
     * @var string
     */
    protected $_template = 'Itoris_GroupedProductConfiguration::bundle/option/radio.phtml';
