 ...
 */
class Select extends \Itoris\GroupedProductConfiguration\Block\Frontend\Option
{
    /**
     * @var string
     */
    protected $_template = 'Itoris_GroupedProductConfiguration::bundle/option/select.phtml';
