 ...
 */
class Multi extends \Itoris\GroupedProductConfiguration\Block\Frontend\Option
{
    /**
     * @var string
     */
    protected $_template = 'Itoris_GroupedProductConfiguration::bundle/option/multi.phtml';
