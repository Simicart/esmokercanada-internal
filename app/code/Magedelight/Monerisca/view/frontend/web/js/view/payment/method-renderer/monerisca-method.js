define(
    ...
    function (
       ...
       fullScreenLoader,
        ...
        'use strict';
        var configMoneris = window.checkoutConfig.payment.md_monerisca;
        
        
        return Component.extend({
            
            defaults: {
                template: 'Magedelight_Monerisca/payment/monerisca',
                 creditCardType: '',
                creditCardExpYear: '',
                creditCardExpMonth: '',
                creditCardNumber: '',
           ...
           initialize: function () {
                ...
                this.creditCardNumber.subscribe(function (value) {
                    ...
                    if (result.isValid) {
                        ...
                        var availableTypes = configMoneris.availableCardTypes;
            ...
            getData: function() {
                return {
                    ...
                    'additional_data': {
                        'data_key': $('#'+this.getCode()+'_payment_profile_id').val(),
            ...
            hasVerification: function() {
              //  return window.checkoutConfig.payment.ccform.hasVerification[this.getCode()];
                return configMoneris.hasVerification;
            },
            ...
            getCcMonthsValues: function() {
                return _.map(configMoneris.ccMonths, function(value, key) {
                    return {
                        'value': key,
                        'month': value
                    }
            ...
            getCcYearsValues: function() {
                return _.map(configMoneris.ccYears, function(value, key) {
                    return {
                        'value': key,
                        'year': value
                    }
            ...
            getStoredCard: function(){
                ...
                return _.map(configMoneris.storedCards, function(value, key) {
                    return {
                        'value': key,
                        'optText': value
                    }
            ...
            isNewEnabled: function(){
                var result = true;
                if(_.size(configMoneris.storedCards) > 1){
                    result =  false;
                }
                return result;
            },
            isStoreCardDropdownEnabled: function()
            {
                ...
                else if(_.size(configMoneris.storedCards) == 1)
                {
            ...
            isSaveCardOptional: function(){
                return (configMoneris.canSaveCard == 0) ? true: false;
            },
            prepareCsPayment: function(){
                if ($('#monerisca-transparent-form').valid()) {
                    this.placeOrder();
                  }
            },
