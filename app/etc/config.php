...
return [
    'modules' => [
        ...
        'Custom_Design' => 0,
        'Custom_ExportChanges' => 0,
        'Custom_SalesPlugin' => 0,
        'Custom_ShipStatus' => 0,
        'Custom_Signupfix' => 0,
        'Custom_Signupvalidate' => 0,
        'Cynoinfotech_ImagesAlt' => 0,
        ...
        'Magebees_Urlrewrite' => 0,
        'Magedelight_Base' => 1,
        'Magedelight_Monerisca' => 1,
        'Magefan_Blog' => 0,
        ...
        'Mageplaza_Search' => 1,
        'Mageplaza_Smtp' => 1,
        'Magestore_Customercredit' => 0,
        'Magestore_InventorySuccess' => 0,
        'Magestore_PurchaseOrderSuccess' => 0,
        'Magetrend_PdfTemplates' => 1,
        'Mlx_Core' => 0,
        'Mlx_PrintShippingLabel2' => 0,
        'Nuwaus_Popup' => 0,
        'PL_Psigate' => 1,
        'PayPal_Braintree' => 1,
        ...
        'Vsourz_Ageverification' => 0,
        'Webkul_Customregister' => 0,
        'WeltPixel_Backend' => 0,
        'Xtento_XtCore' => 0,
