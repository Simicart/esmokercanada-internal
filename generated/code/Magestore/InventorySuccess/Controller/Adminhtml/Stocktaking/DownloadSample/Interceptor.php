<?php
namespace Magestore\InventorySuccess\Controller\Adminhtml\Stocktaking\DownloadSample;

/**
 * Interceptor class for @see \Magestore\InventorySuccess\Controller\Adminhtml\Stocktaking\DownloadSample
 */
class Interceptor extends \Magestore\InventorySuccess\Controller\Adminhtml\Stocktaking\DownloadSample implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $moduleManager, $systemHelper, $stocktakingManagement, $stocktakingFactory, $stocktakingResource, $stockChange, $adminSession, $fileFactory, $filesystem, $csvProcessor, $assetRepo);
    }
