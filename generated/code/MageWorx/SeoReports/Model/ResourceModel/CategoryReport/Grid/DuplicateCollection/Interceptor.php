<?php
namespace MageWorx\SeoReports\Model\ResourceModel\CategoryReport\Grid\DuplicateCollection;

/**
 * Interceptor class for @see \MageWorx\SeoReports\Model\ResourceModel\CategoryReport\Grid\DuplicateCollection
 */
class Interceptor extends \MageWorx\SeoReports\Model\ResourceModel\CategoryReport\Grid\DuplicateCollection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\MageWorx\SeoReports\Model\Config\Category $reportConfig, \MageWorx\SeoReports\Model\ResourceModel\CollectionHelper $collectionHelper, \Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, $mainTable, $eventPrefix, $eventObject, $resourceModel, $model = 'Magento\\Framework\\View\\Element\\UiComponent\\DataProvider\\Document', $connection = null, ?\Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
